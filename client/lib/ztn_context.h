...
#ifndef ZTN_CONTEXT_H
#define ZTN_CONTEXT_H 1
...
/* * */
struct ztn_gpg_sig {
    struct ztn_gpg_sig *next; /* *<链接到下一个成员 */
...
typedef struct ztn_gpg_sig *ztn_gpg_sig_t;
#endif /* HAVE_LIBGPGME */

/* * */
struct ztn_context {
    /* *\name ZTN SPA用户可定义消息数据 */
    ...
    ztn_gpg_sig_t   gpg_sigs; //GPG签名信息
